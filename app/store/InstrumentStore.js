		...
		data: [
			{
				...
				description: [
								...
								'criteria. It is meant to be used by individuals who are familiar with the ', 
								...
								'Follow-up questions can be based on clinical judgment to clarify ambiguous responses. ',
